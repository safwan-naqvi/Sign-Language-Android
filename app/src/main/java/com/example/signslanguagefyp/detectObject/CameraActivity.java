...
public abstract class CameraActivity extends AppCompatActivity
    ...
    com.example.signslanguagefyp.detectObject.CameraConnectionFragment camera2Fragment;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        materialButtonToggleGroup = findViewById(R.id.toggle_menu_group);
        change_text = findViewById(R.id.change_text_detect);
    ...
    protected void setFragment() {
        ...
        if (useCamera2API) {
            camera2Fragment =
                    com.example.signslanguagefyp.detectObject.CameraConnectionFragment.newInstance(
                            new com.example.signslanguagefyp.detectObject.CameraConnectionFragment.ConnectionCallback() {
                                @Override
            ...
            fragment = new com.example.signslanguagefyp.detectObject.LegacyCameraConnectionFragment(this, getLayoutId(), getDesiredPreviewFrameSize());
        }
